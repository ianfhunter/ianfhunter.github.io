...
graph LR;
    ...
    Kiki -- Spreading rumour that she likes Seeker --> Yalia
    Gwen -- To set up with --> Coburn
    Yasht -- To set up with --> Coburn
    Coburn -- Dating --> Winifred
    Kiki -- BFF Betrayal --> Shivonne
    Kiki -- BFF Betrayal --> Cordelia
```
